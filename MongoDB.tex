...
La sezione \ref{mole} fornirà inoltre elementi per comprendere come queste caratteristiche hanno reso MongoDB lo strumento più adatto ad essere integrato nell'applicazione oggetto di tesi. Nella configurazione finale, infatti, esso verrà installato proprio su un servizio di tipo PaaS.