...
Il formato dei messaggi di errore interpretato da questo \textit{tool} ha una struttura fissa e non consente l'aggiunta di dati addizionali personalizzati. Questo aspetto rende Airbrake uno strumento poco adatto al tracciamento di messaggi con formati diversi dagli eventi di errore.
...
\begin{figure}[h]
\centering
\includegraphics[width=1.0\linewidth]{./img/functionalities}
\caption[Tabella comparativa delle funzionalità]{Tabella comparativa delle funzionalità}\label{tab:comparazione-funzionalita}
\end{figure}