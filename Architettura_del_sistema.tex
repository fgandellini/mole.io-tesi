...
\begin{description}
\item [Insertion] è la porzione di sistema che si occupa dell'inserimento dei dati provenienti dall'esterno. Questa sezione è composta, a sua volta, dai \textit{mole-contact} e dal server \textit{mole}. La sezione \ref{mole} si occupa di descrivere i dettagli dell'architettura del layer di insertion.  
...
\item validare la richiesta ed eseguire funzionalità specifiche associate al middleware stesso;
