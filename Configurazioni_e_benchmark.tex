...
Si è quindi scelto di testare il sistema cercando di mettere 

stress, procedure di scrittura dati nel sistema

Per il \textit{testing} è stata quindi posta l'attenzione al  
