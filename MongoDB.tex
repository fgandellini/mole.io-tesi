Il salvataggio dei dati è una operazione critica in moltissimi sistemi software. La scelta del tipo di database da utilizzare per salvare le informazioni è altrettanto delicata e va ponderata alla luce di svariati punti di vista. Per la realizzazione della applicazione oggetto di tesi, si è scelto di utilizzare MongoDB \cite{website:MongoDB}. Di seguito verranno illustrate le principali caratteristiche di questo database e le motivazioni che sottendono tale scelta.\\
