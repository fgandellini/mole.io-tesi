...
\item il server di autenticazione di Twitter esegue la verifica di identità dell'utente e, in caso di esisto positivo, esegue un reindirizzamento verso un URL fornito dall'applicazione restituendo il token identificativo e un codice di verifica dell'utente;
