...
Una tecnica comune per affrontare il problema dell'\textit{I/O} è l'utilizzo di \textit{thread}. Un thread è spesso definito con il termine "sotto-processo leggero", in effetti esso condivide codice e risorse di sistema con altri thread appartenenti allo stesso processo padre.
