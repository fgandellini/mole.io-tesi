...
-----
\\
Per comprendere come Node.js è in grado di realizzare tale funzionalità, è necessario spiegare nel dettaglio il modello di gestione delle richieste implementato da questo framework. 
