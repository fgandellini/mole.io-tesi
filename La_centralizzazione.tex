L'azienda che ha ospitato lo \textit{stage} di Tesi, Codice Plastico, è una realtà che opera nel mercato IT sviluppando applicazioni su misura di tipo \textit{mobile}, \textit{web} e \textit{desktop}.
Il contesto dal quale è nato lo sviluppo di questo progetto è stato la necessità di trovare una soluzione per centralizzare i log in un unico sistema, facilmente accessibile e con un'interfaccia utente \textit{user-friendly}. 
