...
\item [mongoose e mongoskin] Sono i due principali \textit{driver} Node.js per MongoDB, il sistema per l'archiviazione dei dati che abbiamo utilizzato nell'applicazione. Nella sezione \ref{MongoDB} verrà illustrato nel dettaglio questo database documentale e si mostrerà come è possibile accedere alla sua interfaccia utilizzando Node.js.
